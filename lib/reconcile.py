...
def execute_bash(command):
    """Execute a bash command; uses 300s timeout and module-level BASH_OUTPUT_LIMIT."""
    return _execute_bash(command, timeout=300, bash_output_limit=BASH_OUTPUT_LIMIT)
